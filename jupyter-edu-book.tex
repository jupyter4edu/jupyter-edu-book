...
platform that is used by educators in the classroom, to develop teaching
materials, to the share lessons and tutorials, and to the create
computational stories. Notebooks are documents containing text
narratives with images and math, combined with executable code (many
languages are supported) and the output of that code. This marriage of
content and code makes for a powerful new form of data-based
