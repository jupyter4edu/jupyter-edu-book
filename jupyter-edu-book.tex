...
\chapter{Chapter 7: Usage case
studies}\label{chapter-7-usage-case-studies}
...
\chapter{Jupyter Notebooks in Support of Scaling for Large
Enrollments}\label{jupyter-notebooks-in-support-of-scaling-for-large-enrollments}

\section{Supporting large enrollment courses at UC
...
\section{Large-scale adoption: Jupyter across
...
\section{Quick switch: moving an existing course to Python and Jupyter
(at the last
...
\chapter{\texorpdfstring{The ``CFD Python'' story: Guiding Learners at
their Own
...
\chapter{Interactivity in Computer Science (high school and middle
...
\chapter{Interactive geophysics with
...
\chapter{Investigating Hurricanes}\label{investigating-hurricanes}
