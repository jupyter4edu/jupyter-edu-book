...
\chapter{Chapter 6. Getting Your Class Going with
Jupyter}\label{chapter-6.-getting-your-class-going-with-jupyter}
...
\item
  ...
  \textbf{Binder} (\href{https://mybinder.org}{https://mybinder.}org) is
  an open-source service provided by Project Jupyter. It allows the
  owner of a set of notebooks residing in a git repository to pre-build
  an image in the Binder service, and get a shareable link that any
  visitor can click to obtain a working instance of JupyterHub, with the
...
\chapter{Distribution and Collection of
...
(LTI)}(\url{https://open.edx.org/learning-tools-interoperability})
...
but nbviewer is a web service that renders notebooks
...
\chapter{Assessing student learning with Jupyter
...
example CoCalc (\url{www.cocalc.com}) and Vocareum
(\url{www.vocareum.com}) provide a cloud notebook platform that can also
perform assessment similar to nbgrader.
...
(\url{https://www.vocareum.com)_}

\section{}\label{section}

\chapter{How do you create Jupyter Notebooks for reuse and
...
\textbf{Jupyter: a 21st Century Genre of Open Educational Resources and
Practices}
