...
extensions contributed by a large community. Jupyter Notebook exploded
in popularity since late 2014, fueled by its adoption as the favorite
...
and tutorials, and to create computational stories. Notebooks are
