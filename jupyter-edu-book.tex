...
\textbf{Description:} This pattern is focusses attention on one
component of a multi-step workflow. Learners are asked to implement one
stage of a workflow while preceeding and subsequent stages may be
provided to them.

\textbf{Example:} In a climate-science exercise, the notebook that is
provided to students provides code for fetching and parsing 20 years of
...
and standard deviation. Plotting code which plots the yearly temperature
...
instructor input in order to get students started.
