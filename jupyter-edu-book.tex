...
code cell. In fact, instead of adding comments in code, consider moving
the comments out of the code cell into a markdown cell either directly
above or below the code cell. This often reads much better, and gives
you more flexibilty in discussing or describing the code. However, short
comments in a block of code can still be useful.

\subsection{How much code should go in a
cell?}\label{how-much-code-should-go-in-a-cell}

How much code should you put in a cell? You will develop your own style
of writing noteooks with experience, but we recommend putting code that
...
of code: one that creates an item, and the second that initializes it.
It may be a good idea to put those into the same cell so that they are
always executed together. Otherwise, the student may encounter errors if
they execute cells again.
...
Asking probing questions in a Socratic method is very useful technique
...
teaching students how to effectively weave code into their own notebook
stories is a very effective use of the notebook.
