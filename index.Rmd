...
digital humanities. It aims to give an entry point, and a broad overview of
...
never heard of Jupyter, the material in this open book can help you empower your
...
IPython, the Jupyter Notebook, JupyterHub, and an ecosystem of extensions
contributed by a large community. Jupyter Notebook exploded in popularity since
...
computational stories. Notebooks are documents containing text narratives,
...
myriad of blog posts and talk videos to distill the patterns of good practices
...
sharing open documentation about using Jupyter for teaching and learning. The
result is this open book: a live document of collective experience with Jupyter
in education.
